...
export const gameCopy = {
  ...
  puzzle: {
    ...
    ruleStart: { en: "• Start on the START tile", ar: "• ابدأ من خانة البداية" },
    ruleAdjacent: { en: "• Move to any adjacent box, including corner/diagonal ones", ar: "• تحرك إلى أي مربع مجاور، بما في ذلك المربعات القطرية/الزاوية" },
    ruleNoRevisit: { en: "• No revisiting tiles", ar: "• لا يمكنك زيارة نفس المربع مرتين" },
    ruleCrabs: { en: "• Avoid crabs 🦀", ar: "• تجنب السرطانات 🦀" },
    ruleKey: { en: "• Get the key BEFORE reaching the treasure box", ar: "• احصل على المفتاح قبل الوصول إلى صندوق الكنز" },
    ...
    continue: { en: "Continue", ar: "متابعة" },
    status: {
      idle: { en: "Click the START tile to begin.", ar: "اضغط على خانة البداية للبدء." },
      playing: { en: "Navigate to the treasure box!", ar: "اتجه إلى صندوق الكنز!" },
      ...
      fail_no_key: { en: "🔒 The treasure box is locked — you didn't get the key first.", ar: "🔒 صندوق الكنز مقفل — لم تحصل على المفتاح أولاً." },
    },
  },
  longTerm: {
